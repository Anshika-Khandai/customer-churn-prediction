...
**[Try the Live Application](https://Anshika-Khandai/customer-churn-prediction-030625.streamlit.app/)**
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Anshika-Khandai/customer-churn-prediction.git
...
1. Create a new issue if needed. Check the [Issues](https://github.com/Anshika-Khandai/customer-churn-prediction/issues) page 
2. Contact: khandaianshika99@gmail.com
